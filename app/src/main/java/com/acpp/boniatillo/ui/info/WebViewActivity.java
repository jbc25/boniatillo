package com.acpp.boniatillo.ui.info;
...
public class WebViewActivity extends BaseActivity {
    ...
    public static final String FILENAME_ACPP = "acpp.html";
    public static final String FILENAME_EL_BONIATILLO = "el_boniatillo.html";

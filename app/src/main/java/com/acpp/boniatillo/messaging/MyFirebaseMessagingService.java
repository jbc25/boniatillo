package com.acpp.boniatillo.messaging;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onNewToken(String token) {
        ...
        App.getPrefs(getBaseContext()).edit().putBoolean(App.SHARED_TOKEN_FIREBASE_SENT, false).commit();
    }
...
//        App.openBonificationDialog(this, title, message );
    ...
    private void sendNotification(String title, String text, Bundle extras) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.mipmap.ic_acpp_no_circle_small)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.ic_app_acpp))
